/**************************************************************************************************
module	:	U2D3DXEffectParams
Author	:	Yun sangyong
Desc	:	
**************************************************************************************************/
#pragma once
#ifndef U2_D3DXEFFECTPARAMS_H
#define U2_D3DXEFFECTPARAMS_H


namespace U2FxShaderState 
{
	...
	enum Param
	{
		...
		Projection,                     // matrix: fthe projection matrix
		...
		NormalMap,						// add 2010/06/08	NormalMap
		ShadowColor,					// add 2010/06/12	shadowmap(debug)
		...
		//Add 2010/06/07 Terrain variables
		BiasU,
		BiasV, 
		NormalScale, 
		TexelSize,
