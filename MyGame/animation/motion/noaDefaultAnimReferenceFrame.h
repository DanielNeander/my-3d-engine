#ifndef MOTION_DEFAULT_ANIMREFERENCEFRAME_H
#define MOTION_DEFAULT_ANIMREFERENCEFRAME_H

#include <Common/Base/hkBase.h>
#include <Animation/Rig/noaBone.h>

class noaDefaultAnmRefFrame {
...
public:
	struct MotionExtractionOptions
	{
		...
		/// to calculate and store the motion. Minimum (and default) number is two.v
	...
	noaDefaultAnmRefFrame( const MotionExtractionOptions& options );


	/// Destructor; it deallocates the memory used to store the motion track
	~noaDefaultAnmRefFrame();
