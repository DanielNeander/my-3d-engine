...
#include <Math/Math.h>
#include <UnitTests/hkTest.h>
#include <UnitTests/hkgTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION ( hkTest );
CPPUNIT_TEST_SUITE_REGISTRATION ( hkgTest );
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
	...
	g_renderSystem = new noRenderSystemDX9;
