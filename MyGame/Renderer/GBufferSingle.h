//-----------------------------------------------------------------------------
// File: GBufferSingle.h
//
// Desc: Header file GBufferSingle class (single render target G-Buffer)
//-----------------------------------------------------------------------------
#pragma once
...
class GBufferSingle : public GBuffer
{
public:
	GBufferSingle( LPDIRECT3D9 pD3D, LPDIRECT3DDEVICE9 pD3DDevice );
	~GBufferSingle();
