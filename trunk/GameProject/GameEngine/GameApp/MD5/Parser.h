...
private:
	...
	class idLexer *		scriptstack;				// stack with scripts of the source
	class idToken *		tokens;						// tokens to read first
...
ID_INLINE const time_t idParser::GetFileTime( void ) const {
	if ( idParser::scriptstack ) {
