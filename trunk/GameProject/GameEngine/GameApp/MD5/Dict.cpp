...
================
*/
bool idDict::GetAngles( const char *key, const char *defaultString, noAngles &out ) const {
	bool		found;
	const char	*s;
...
================
*/
bool idDict::GetVector( const char *key, const char *defaultString, noVec3 &out ) const {
	bool		found;
	const char	*s;
...
================
*/
bool idDict::GetVec2( const char *key, const char *defaultString, noVec2 &out ) const {
	bool		found;
	const char	*s;
...
================
*/
bool idDict::GetVec4( const char *key, const char *defaultString, noVec4 &out ) const {
	bool		found;
	const char	*s;
...
================
*/
bool idDict::GetMatrix( const char *key, const char *defaultString, noMat3 &out ) const {
	const char	*s;
	bool		found;
...
void idDict::WriteToFileHandle( idFile *f ) const {
	int c = args.Num();//LittleLong( args.Num() );
	f->Write( &c, sizeof( c ) );
