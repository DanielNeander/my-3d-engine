...
typedef bool (*getJointTransform_t)( void *model, const idJointMat *frame, const char *jointName, noVec3 &origin, noMat3 &axis );
...
public:
	...
	const noVec3 &			ToVec3( void ) const { return vec; }
	noVec3 &				ToVec3( void ) { return vec; }
...
public:
	...
	float					totalMass;
	noVec2					suspendVelocity;
	noVec2					suspendAcceleration;
	float					noMoveTime;
