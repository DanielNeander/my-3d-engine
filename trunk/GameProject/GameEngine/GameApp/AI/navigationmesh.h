/*$T navigationmesh.h GC 1.140 01/03/12 01:39:30 */
...
/**
 *  \ NavigationMesh.h NavigationMesh component interface for the Navimesh sample program. Included as part of the Game
...
/*
 * NavigationMesh A NavigationMesh is a collecion of NavigationCells used to
 * control object movement while also providing path finding line-of-sight
 * testing. It serves as a parent to all the Actor objects which exist upon it.
 */
...
public:
	...
	noVec3									SnapPointToCell(NavigationCell *Cell, const noVec3 &Point);
	noVec3									SnapPointToMesh(NavigationCell **CellOut, const noVec3 &Point);
	NavigationCell							*FindClosestCell(const noVec3 &Point) const;
...
/*
 =======================================================================================================================
    ...
    NavigationMesh Default Object Constructor
 =======================================================================================================================
 */
...
/*
 =======================================================================================================================
    ~NavigationMesh Default Object Destructor
 =======================================================================================================================
 */
inline NavigationMesh::~NavigationMesh()
{
...
/*
 ...
 =======================================================================================================================
 */
inline void NavigationMesh::AddCell(const noVec3 &PointA, const noVec3 &PointB, const noVec3 &PointC)
{
