...
class Bitwise {
    public:
        ...
        */
        static NO_INLINE unsigned int mostSignificantBitSet(unsigned int value)
        {
        ...
        */
        static NO_INLINE uint32 firstPO2From(uint32 n)
        {
            --n;            
            n |= n >> 16;
            n |= n >> 8;
        ...
        */
        template<typename T>
        static NO_INLINE bool isPO2(T n)
        {
            return (n & (n-1)) == 0;
        }
        ...
        */
		template<typename T>
        static NO_INLINE unsigned int getBitShift(T mask)
		{
			if (mask == 0)
				return 0;
