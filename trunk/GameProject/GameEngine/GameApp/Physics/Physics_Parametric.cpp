...
//	noVec3 linearStartValue, linearBaseSpeed, linearSpeed, startPos, endPos;
//	noAngles angularStartValue, angularBaseSpeed, angularSpeed, startAng, endAng;
//
...
================
*/
void idPhysics_Parametric::SetLinearExtrapolation( extrapolation_t type, int time, int duration, const noVec3 &base, const noVec3 &speed, const noVec3 &baseSpeed ) {
	current.time = gameLocal.time;
...
================
*/
void idPhysics_Parametric::SetAngularExtrapolation( extrapolation_t type, int time, int duration, const noAngles &base, const noAngles &speed, const noAngles &baseSpeed ) {
	current.time = gameLocal.time;
...
================
*/
void idPhysics_Parametric::SetLinearInterpolation( int time, int accelTime, int decelTime, int duration, const noVec3 &startPos, const noVec3 &endPos ) {
	current.time = gameLocal.time;
...
================
*/
void idPhysics_Parametric::SetAngularInterpolation( int time, int accelTime, int decelTime, int duration, const noAngles &startAng, const noAngles &endAng ) {
	current.time = gameLocal.time;
...
================
*/
void idPhysics_Parametric::SetSpline( idCurve_Spline<noVec3> *spline, int accelTime, int decelTime, bool useSplineAngles ) {
	if ( current.spline != NULL ) {
		delete current.spline;
		current.spline = NULL;
	}
...
================
*/
idCurve_Spline<noVec3> *idPhysics_Parametric::GetSpline( void ) const {
...
================
*/
void idPhysics_Parametric::GetLocalOrigin( noVec3 &curOrigin ) const {
...
================
*/
void idPhysics_Parametric::GetLocalAngles( noAngles &curAngles ) const {
...
bool idPhysics_Parametric::Evaluate( int timeStepMSec, int endTimeMSec ) {
	noVec3 oldLocalOrigin, oldOrigin, masterOrigin;
	noAngles oldLocalAngles, oldAngles;
	noMat3 oldAxis, masterAxis;
...
================
*/
void idPhysics_Parametric::SetOrigin( const noVec3 &newOrigin, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Parametric::SetAxis( const noMat3 &newAxis, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Parametric::Translate( const noVec3 &translation, int id ) {
}
...
================
*/
void idPhysics_Parametric::Rotate( const noRotation &rotation, int id ) {
}
...
================
*/
const noVec3 &idPhysics_Parametric::GetOrigin( int id ) const {
...
================
*/
const noMat3 &idPhysics_Parametric::GetAxis( int id ) const {
	return current.axis;
}
...
================
*/
void idPhysics_Parametric::GetAngles( noAngles &curAngles ) const {
...
================
*/
void idPhysics_Parametric::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
...
================
*/
void idPhysics_Parametric::SetAngularVelocity( const noVec3 &newAngularVelocity, int id ) {
	noRotation rotation;
	noVec3 vec;
	float angle;
...
================
*/
const noVec3 &idPhysics_Parametric::GetLinearVelocity( int id ) const {
	static noVec3 curLinearVelocity;
...
================
*/
const noVec3 &idPhysics_Parametric::GetAngularVelocity( int id ) const {
	static noVec3 curAngularVelocity;
	noAngles angles;
...
int idPhysics_Parametric::GetLinearEndTime( void ) const {
	if ( current.spline != NULL ) {
		if ( current.spline->GetBoundaryType() != idCurve_Spline<noVec3>::BT_CLOSED ) {
...
void idPhysics_Parametric::ReadFromSnapshot( const idBitMsgDelta &msg ) {
	...
	noVec3 linearStartValue, linearSpeed, linearBaseSpeed, startPos, endPos;
	noAngles angularStartValue, angularSpeed, angularBaseSpeed, startAng, endAng;
