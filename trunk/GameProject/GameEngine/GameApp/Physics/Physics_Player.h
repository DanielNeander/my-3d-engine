...
public:
	...
	void					SetPlayerInput( const usercmd_t &cmd, const noAngles &newViewAngles );
	...
	const noVec3 &			PlayerGetOrigin( void ) const;	// != GetOrigin
...
private:
	...
	void					Accelerate( const noVec3 &wishdir, const float wishspeed, const float accel );
