...
================
*/
void idPhysics_StaticMulti::GetImpactInfo( const int id, const noVec3 &point, impactInfo_t *info ) const {
...
================
*/
void idPhysics_StaticMulti::ApplyImpulse( const int id, const noVec3 &point, const noVec3 &impulse ) {
}
...
================
*/
void idPhysics_StaticMulti::AddForce( const int id, const noVec3 &point, const noVec3 &force ) {
}
...
================
*/
void idPhysics_StaticMulti::SetOrigin( const noVec3 &newOrigin, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_StaticMulti::SetAxis( const noMat3 &newAxis, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_StaticMulti::Translate( const noVec3 &translation, int id ) {
	int i;
...
================
*/
void idPhysics_StaticMulti::Rotate( const noRotation &rotation, int id ) {
	int i;
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetOrigin( int id ) const {
	if ( id >= 0 && id < clipModels.Num() ) {
...
================
*/
const noMat3 &idPhysics_StaticMulti::GetAxis( int id ) const {
	if ( id >= 0 && id < clipModels.Num() ) {
...
================
*/
void idPhysics_StaticMulti::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
}
...
================
*/
void idPhysics_StaticMulti::SetAngularVelocity( const noVec3 &newAngularVelocity, int id ) {
}
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetLinearVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetAngularVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
void idPhysics_StaticMulti::SetGravity( const noVec3 &newGravity ) {
}
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetGravity( void ) const {
	static noVec3 gravity( 0, 0, -g_gravity.GetFloat() );
	return gravity;
}
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetGravityNormal( void ) const {
	static noVec3 gravity( 0, 0, -1 );
	return gravity;
}
...
================
*/
void idPhysics_StaticMulti::ClipTranslation( trace_t &results, const noVec3 &translation, const idClipModel *model ) const {
...
================
*/
void idPhysics_StaticMulti::ClipRotation( trace_t &results, const noRotation &rotation, const idClipModel *model ) const {
	memset( &results, 0, sizeof( trace_t ) );
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetPushedLinearVelocity( const int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_StaticMulti::GetPushedAngularVelocity( const int id ) const {
	return vec3_origin;
}
