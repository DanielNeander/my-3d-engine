...
================
*/
void idPhysics_Base::GetImpactInfo( const int id, const noVec3 &point, impactInfo_t *info ) const {
...
================
*/
void idPhysics_Base::ApplyImpulse( const int id, const noVec3 &point, const noVec3 &impulse ) {
}
...
================
*/
void idPhysics_Base::AddForce( const int id, const noVec3 &point, const noVec3 &force ) {
}
...
================
*/
void idPhysics_Base::SetOrigin( const noVec3 &newOrigin, int id ) {
}
...
================
*/
void idPhysics_Base::SetAxis( const noMat3 &newAxis, int id ) {
}
...
================
*/
void idPhysics_Base::Translate( const noVec3 &translation, int id ) {
}
...
================
*/
void idPhysics_Base::Rotate( const noRotation &rotation, int id ) {
}
...
================
*/
const noVec3 &idPhysics_Base::GetOrigin( int id ) const {
	return vec3_origin;
}
...
================
*/
const noMat3 &idPhysics_Base::GetAxis( int id ) const {
...
================
*/
void idPhysics_Base::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
}
...
================
*/
void idPhysics_Base::SetAngularVelocity( const noVec3 &newAngularVelocity, int id ) {
}
...
================
*/
const noVec3 &idPhysics_Base::GetLinearVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_Base::GetAngularVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
void idPhysics_Base::SetGravity( const noVec3 &newGravity ) {
...
================
*/
const noVec3 &idPhysics_Base::GetGravity( void ) const {
...
================
*/
const noVec3 &idPhysics_Base::GetGravityNormal( void ) const {
...
================
*/
void idPhysics_Base::ClipTranslation( trace_t &results, const noVec3 &translation, const idClipModel *model ) const {
...
================
*/
void idPhysics_Base::ClipRotation( trace_t &results, const noRotation &rotation, const idClipModel *model ) const {
	memset( &results, 0, sizeof( trace_t ) );
}
...
================
*/
const noVec3 &idPhysics_Base::GetPushedLinearVelocity( const int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_Base::GetPushedAngularVelocity( const int id ) const {
	return vec3_origin;
}
...
void idPhysics_Base::DrawVelocity( int id, float linearScale, float angularScale ) const {
	...
	if ( length > 0.1f ) {
		...
		for ( a = 20.0f; a < length; a += 20.0f ) {
			end = org + noRotation( vec3_origin, dir, -a ).ToMat3() * vec;
			//gameRenderWorld->DebugLine( colorBlue, start, end, 1 );
			start = end;
		}
		end = org + noRotation( vec3_origin, dir, -length ).ToMat3() * vec;
