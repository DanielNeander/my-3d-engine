...
================
*/
void idForce_Drag::SetPhysics( idPhysics *phys, int id, const noVec3 &p ) {
	this->physics = phys;
	this->id = id;
	this->p = p;
}
...
================
*/
void idForce_Drag::SetDragPosition( const noVec3 &pos ) {
...
================
*/
const noVec3 &idForce_Drag::GetDragPosition( void ) const {
...
================
*/
const noVec3 idForce_Drag::GetDraggedPosition( void ) const {
...
void idForce_Drag::Evaluate( int time ) {
	float l1, l2, mass;
	noVec3 dragOrigin, dir1, dir2, velocity, centerOfMass;
