...
================
*/
const noMat3 &idPhysics_Actor::GetGravityAxis( void ) const {
...
================
*/
const noVec3 &idPhysics_Actor::GetOrigin( int id ) const {
...
================
*/
const noMat3 &idPhysics_Actor::GetAxis( int id ) const {
...
================
*/
void idPhysics_Actor::SetGravity( const noVec3 &newGravity ) {
...
================
*/
void idPhysics_Actor::ClipTranslation( trace_t &results, const noVec3 &translation, const idClipModel *model ) const {
	if ( model ) {
...
================
*/
void idPhysics_Actor::ClipRotation( trace_t &results, const noRotation &rotation, const idClipModel *model ) const {
	if ( model ) {
