...
public:
	...
	void				FromPlanes( const noPlane *planes, const int numPlanes );
	...
	int					SplitPolytope( const noPlane &plane, const float epsilon, idSurface_Polytope **front, idSurface_Polytope **back ) const;
