...
public:
	...
	void			SetRotation( const noMat3 &m );
	void			SetTranslation( const noVec3 &t );

	noVec3			operator*( const noVec3 &v ) const;							// only rotate
	noVec3			operator*( const noVec4 &v ) const;							// rotate and translate
...
ID_INLINE void idJointMat::SetRotation( const noMat3 &m ) {
...
ID_INLINE void idJointMat::SetTranslation( const noVec3 &t ) {
	mat[0 * 4 + 3] = t[0];
	mat[1 * 4 + 3] = t[1];
	mat[2 * 4 + 3] = t[2];
}

ID_INLINE noVec3 idJointMat::operator*( const noVec3 &v ) const {
	return noVec3(	mat[0 * 4 + 0] * v[0] + mat[0 * 4 + 1] * v[1] + mat[0 * 4 + 2] * v[2],
					mat[1 * 4 + 0] * v[0] + mat[1 * 4 + 1] * v[1] + mat[1 * 4 + 2] * v[2],
					mat[2 * 4 + 0] * v[0] + mat[2 * 4 + 1] * v[1] + mat[2 * 4 + 2] * v[2] );
}

ID_INLINE noVec3 idJointMat::operator*( const noVec4 &v ) const {
	return noVec3(	mat[0 * 4 + 0] * v[0] + mat[0 * 4 + 1] * v[1] + mat[0 * 4 + 2] * v[2] + mat[0 * 4 + 3] * v[3],
...
ID_INLINE noMat3 idJointMat::ToMat3( void ) const {
	return noMat3(	mat[0 * 4 + 0], mat[1 * 4 + 0], mat[2 * 4 + 0],
					mat[0 * 4 + 1], mat[1 * 4 + 1], mat[2 * 4 + 1],
					mat[0 * 4 + 2], mat[1 * 4 + 2], mat[2 * 4 + 2] );
}

ID_INLINE noVec3 idJointMat::ToVec3( void ) const {
	return noVec3( mat[0 * 4 + 3], mat[1 * 4 + 3], mat[2 * 4 + 3] );
}
