...
============
*/
float SSE3_Dot( const noVec4 &v1, const noVec4 &v2 ) {
	float d;
	__asm {
		mov		esi, v1
		mov		edi, v2
...
============
*/
void VPCALL idSIMD_SSE3::TransformVerts( idDrawVert *verts, const int numVerts, const idJointMat *joints, const noVec4 *weights, const int *index, const int numWeights ) {
#if 1
