...
public:
	...
	friend FArchive& operator<<(FArchive& Ar, TBitArray& BitArray)
	{
		...
		{
			// delete any old data
			BitArray.Empty(BitArray.NumBits);
		}
		...
		const INT NumDWORDs = (BitArray.NumBits + TBitArray::NumBitsPerDWORD - 1) / TBitArray::NumBitsPerDWORD;
	...
	public:
		...
		typedef INT FIterator::*PrivateBooleanType;
	...
	public:
		...
		/** conversion to "bool" returning TRUE if the iterator is valid. */
		typedef INT FConstIterator::*PrivateBooleanType;
...
public:
	...
	/** conversion to "bool" returning TRUE if the iterator is valid. */
	typedef INT TConstSetBitIterator::*PrivateBooleanType;
...
public:
	...
	/** conversion to "bool" returning TRUE if the iterator is valid. */
	typedef INT TConstDualSetBitIterator::*PrivateBooleanType;
