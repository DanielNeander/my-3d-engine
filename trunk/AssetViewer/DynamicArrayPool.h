#ifndef DYNAMICARRAYPOOL_H
#define DYNAMICARRAYPOOL_H
...
template <class TArrayElement> class CDynamicArrayPool 
{
public:
	CDynamicArrayPool(int iNumElements)
	{
		m_iNumElements = iNumElements;

		m_bAlive = U2_ALLOC(bool, iNumElements);
		m_aElements = U2_NEW TArrayElement[iNumElements];
	...
	virtual ~CDynamicArrayPool() {
		U2_FREE(m_bAlive);
		U2_DELETE [] m_aElements;
	}
