...
public:
	...
	void				SetPosition(noVec2 *new_position)						{ m_Position = *new_position; }
	noVec2*			GetPosition()											{ return &m_Position; }
	...
	noVec2*			GetDirection()											{ return &m_Direction; }
...
private:
	...
	noVec2			m_Position;							// Current position of the missile
	float				m_Speed;							// Current speed of the missile (always in the direction of m_Direction)
	noVec2			m_Direction;						// Current direction the missile is facing
