...
class AABBoxRasterizer
{
	public:
		...
		virtual void CreateTransformedAABBoxes(UINT numAssetSets) = 0;
		virtual void TransformAABBoxAndDepthTest() = 0;
		virtual void RenderVisible(UINT numAssetSets) = 0;
		virtual void Render(UINT numAssetSets) = 0;

		virtual void ResetInsideFrustum() = 0; 
		virtual void IsInsideViewFrustum(ShadowMapCamera *pCamera) = 0;
		...
		virtual void SetCamera(ShadowMapCamera *pCamera) = 0;
