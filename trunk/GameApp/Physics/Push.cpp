...
============
*/
bool idPush::RotateEntityToAxial( idEntity *ent, noVec3 rotationPoint ) {
	int i;
	trace_t trace;
	noRotation rotation;
	noMat3 axis;
...
============
*/
bool idPush::ClipTranslationAgainstPusher( trace_t &results, idEntity *ent, idEntity *pusher, const noVec3 &translation ) {
	int i, n;
	trace_t t;
...
int idPush::GetPushableEntitiesForTranslation( idEntity *pusher, idEntity *initialPusher, const int flags,
											const noVec3 &translation, idEntity *entityList[], int maxEntities ) {
	int i, n, l;
...
float idPush::ClipTranslationalPush( trace_t &results, idEntity *pusher, const int flags,
										const noVec3 &newOrigin, const noVec3 &translation ) {
	...
	float totalMass;
	trace_t trace;
	noVec3 realTranslation, partialTranslation;
...
============
*/
bool idPush::ClipRotationAgainstPusher( trace_t &results, idEntity *ent, idEntity *pusher, const noRotation &rotation ) {
	int i, n;
	trace_t t;
...
int idPush::GetPushableEntitiesForRotation( idEntity *pusher, idEntity *initialPusher, const int flags,
											const noRotation &rotation, idEntity *entityList[], int maxEntities ) {
	int i, n, l;
	idBounds bounds, pushBounds;
	idPhysics *physics;
...
float idPush::ClipRotationalPush( trace_t &results, idEntity *pusher, const int flags,
									const noMat3 &newAxis, const noRotation &rotation ) {
	int i, j, numListedEntities;
	idEntity *curPusher, *ent, *entityList[ MAX_GENTITIES ];
	float fraction;
	bool groundContact, blocked = false;
	float totalMass;
	trace_t trace;
	noRotation realRotation, partialRotation;
	noMat3 oldAxis;
...
============
*/
void idPush::ClipEntityRotation( trace_t &trace, const idEntity *ent, const idClipModel *clipModel, idClipModel *skip, const noRotation &rotation ) {
...
============
*/
void idPush::ClipEntityTranslation( trace_t &trace, const idEntity *ent, const idClipModel *clipModel, idClipModel *skip, const noVec3 &translation ) {
...
int idPush::TryRotatePushEntity( trace_t &results, idEntity *check, idClipModel *clipModel, const int flags,
											 const noMat3 &newAxis, const noRotation &rotation ) {
	trace_t trace;
	noVec3 rotationPoint;
	noRotation newRotation;
	float checkAngle;
	idPhysics *physics;
...
int idPush::TryTranslatePushEntity( trace_t &results, idEntity *check, idClipModel *clipModel, const int flags,
										const noVec3 &newOrigin, const noVec3 &move ) {
	trace_t		trace;
	noVec3		checkMove;
	noVec3		oldOrigin;
	idPhysics	*physics;
...
float idPush::ClipTranslationalPush( trace_t &results, idEntity *pusher, const int flags,
	...
	idBounds	bounds, pushBounds;
	noVec3		clipMove, clipOrigin, oldOrigin, dir, impulse;
	trace_t		pushResults;
	bool		wasEnabled;
	float		totalMass;
...
float idPush::ClipRotationalPush( trace_t &results, idEntity *pusher, const int flags,
	...
	idEntity	*check, *entityList[ MAX_GENTITIES ];
	idBounds	bounds, pushBounds;
	noRotation	clipRotation;
	noMat3		clipAxis, oldAxis;
	trace_t		pushResults;
	bool		wasEnabled;
	float		totalMass;
	idClipModel *clipModel;
...
float idPush::ClipPush( trace_t &results, idEntity *pusher, const int flags,
								const noVec3 &oldOrigin, const noMat3 &oldAxis,
									noVec3 &newOrigin, noMat3 &newAxis ) {
	noVec3 translation;
	noRotation rotation;
	float mass;
