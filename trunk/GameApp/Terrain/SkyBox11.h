...
public:
	...
	// Ocean 
	HRESULT OnD3D11CreateDevice2( ID3D11Device* pd3dDevice, float fSize, ID3D11Texture2D* pCubeTexture, ID3D11ShaderResourceView* pCubeRV );
...
protected:
    ...
    ID3D11RasterizerState* m_pRasterizerState11;
