...
/*
 * NavActor An NavActor represents a mobile game object attached to a NavigationMesh.
 * This sample implementation demonstrates how to manuver an object on a
 * NavigationMesh and request path information from the mesh.
 */
class	NavActor
{
/*
...
public:
	...
	struct Triangle
	{
		noVec3			vert[3];		/* triangle vertices in clockwise order */
	...
	virtual void					GotoLocation(const noVec3 &Position, NavigationCell *Cell);
	virtual void					AddMovement(const noVec3 &Movement);
	virtual void					SetMovement(const noVec3 &Movement);
	...
	const noVec3					&Position() const;
	const noVec3					&Movement() const;
...
private:
	...
	NavActor(const NavActor &Src);
	NavActor &operator				=(const NavActor &Src);
};

/*
 =======================================================================================================================
    Inline Functions = CREATORS ;
    NavActor Default Object Constructor
 =======================================================================================================================
 */
inline NavActor::NavActor() :
	m_PathActive(false),
	m_CurrentCell(0),
...
/*
 =======================================================================================================================
    ~NavActor Default Object Destructor
 =======================================================================================================================
 */
inline NavActor::~NavActor()
{ }
...
/*
 =======================================================================================================================
    OPERATORS = MUTATORS ;
    : Create ;
    * Initializes the NavActor object, recording data about it's parent mesh, position and ;
    current cell ;
    * ://
 =======================================================================================================================
 */
inline void NavActor::Create(NavigationMesh *Parent, const noVec3 &Position, NavigationCell *CurrentCell)
{
	m_Parent = Parent;
	m_Position = Position;
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::AddTriangle(const Triangle &triangle)
{
...
/*
 =======================================================================================================================
    : Render ;
    * Renders the NavActor geometry, as well as the current path in use. ;
    * ://
 =======================================================================================================================
 */
inline void NavActor::Render()
{
	//glPushMatrix();
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::Update(float elapsedTime)
{
	float	distance;
	...
	if(m_Movement.x || m_Movement.z)
	{
		...
		if(m_Parent)
		{
			...
			noVec3			NextPosition = m_Position + m_Movement;
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::GotoLocation(const noVec3 &Position, NavigationCell *Cell)
{
	if(m_Parent)
	{
		m_Movement.x = m_Movement.y = m_Movement.z = 0.0f;
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::GotoRandomLocation()
{
	if(m_Parent)
	{
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::AddMovement(const noVec3 &Movement)
{
	m_Movement += Movement;
}
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::SetMovement(const noVec3 &Movement)
{
	m_Movement += Movement;
}
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::SetMovementX(float X)
{
	m_Movement.x += X;
}
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::SetMovementY(float Y)
{
	m_Movement.y += Y;
}
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::SetMovementZ(float Z)
{
	m_Movement.z += Z;
}
...
/*
 ...
 =======================================================================================================================
 */
inline void NavActor::SetMaxSpeed(float speed)
{
	m_MaxSpeed = speed;
}
...
/*
 ...
 =======================================================================================================================
 */
inline bool NavActor::PathIsActive() const
{
	return(m_PathActive);
}
...
/*
 ...
 =======================================================================================================================
 */
inline const noVec3 &NavActor::Position() const
{
	return(m_Position);
}
...
/*
 ...
 =======================================================================================================================
 */
inline const noVec3 &NavActor::Movement() const
{
	return(m_Movement);
}
...
/*
 ...
 =======================================================================================================================
 */
inline NavigationCell *NavActor::CurrentCell() const
{
