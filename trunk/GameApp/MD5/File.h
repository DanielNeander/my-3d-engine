...
public:
	...
	virtual int				ReadVec2( noVec2 &vec );
	virtual int				ReadVec3( noVec3 &vec );
	virtual int				ReadVec4( noVec4 &vec );
	virtual int				ReadVec6( idVec6 &vec );
	virtual int				ReadMat3( noMat3 &mat );
	...
	virtual int				WriteVec2( const noVec2 &vec );
	virtual int				WriteVec3( const noVec3 &vec );
	virtual int				WriteVec4( const noVec4 &vec );
	virtual int				WriteVec6( const idVec6 &vec );
	virtual int				WriteMat3( const noMat3 &mat );
};
