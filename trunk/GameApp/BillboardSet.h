...
class  BillboardSet : public SceneNode
{
public:
	BillboardSet();
	...
	typedef std::vector<Billboard*> BillboardPool;
        ...
        */
		...
		noVec3 mVOffset[4];
		/// Current camera
		class BaseCamera* mCurrentCamera;
        ...
        */
        void genBillboardAxes(noVec3* pX, noVec3 *pY, const Billboard* pBill = 0);
        ...
        */
        ...
        @param offsets Array of 4 noVec3 offsets
        @param bb Reference to billboard
        */
        void genVertices(const noVec3* const offsets, const Billboard& pBillboard);
        ...
        */
        void genVertOffsets(Real inleft, Real inright, Real intop, Real inbottom,
            ...
            const noVec3& x, const noVec3& y, noVec3* pDestVec);
        ...
        struct SortByDirectionFunctor
        {
            ...
            SortByDirectionFunctor(const noVec3& dir);
        ...
        struct SortByDistanceFunctor
        {
            ...
            SortByDistanceFunctor(const noVec3& pos);
            float operator()(Billboard* bill) const;
        };
    ...
    public:
        ...
        */
        explicit BillboardSet(  unsigned int poolSize = 20, 
        ...
        */        
        /** Overridden from MovableObject
            @see
                MovableObject
        */
        virtual void _notifyCurrentCamera(BaseCamera* cam);
		...
		*/
		void setBounds(const BoundingBox& box, Real radius);
        ...
        */        
        ...
        /** Overridden from MovableObject
            @see
                MovableObject
        */
        virtual void getWorldTransforms(mat4* xform) const;
        ...
        */
        virtual void setCommonDirection(const noVec3& vec);

        /** Gets the common direction for all billboards (BBT_ORIENTED_COMMON) */
        virtual const noVec3& getCommonDirection(void) const;
        ...
        */
        virtual void setCommonUpVector(const noVec3& vec);

        /** Gets the common up-vector for all billboards (BBT_PERPENDICULAR_SELF and BBT_PERPENDICULAR_COMMON) */
        virtual const noVec3& getCommonUpVector(void) const;
        ...
        */
        ...
        Real getSquaredViewDepth(const BaseCamera* cam) const;
		...
		virtual void _sortBillboards( BaseCamera* cam);
        ...
        */
        ...
        /** setTextureStacksAndSlices() will generate texture coordinate rects as if the 
          ...
          */
        virtual void setTextureStacksAndSlices( uint8 stacks, uint8 slices );
