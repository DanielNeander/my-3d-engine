...
public:
	...
	void			WriteDir( const noVec3 &dir, int numBits );
	...
	noVec3			ReadDir( int numBits ) const;
	...
	bool			ReadDeltaDict( class idDict &dict, const idDict *base ) const;

	static int		DirToBits( const noVec3 &dir, int numBits );
	static noVec3	BitsToDir( int bits, int numBits );
...
ID_INLINE void idBitMsg::WriteFloat( float f, int exponentBits, int mantissaBits ) {
	int bits = noMath::FloatToBits( f, exponentBits, mantissaBits );
...
ID_INLINE void idBitMsg::WriteDir( const noVec3 &dir, int numBits ) {
...
ID_INLINE void idBitMsg::WriteDeltaFloat( float oldValue, float newValue, int exponentBits, int mantissaBits ) {
	int oldBits = noMath::FloatToBits( oldValue, exponentBits, mantissaBits );
	int newBits = noMath::FloatToBits( newValue, exponentBits, mantissaBits );
...
ID_INLINE float idBitMsg::ReadFloat( int exponentBits, int mantissaBits ) const {
	...
	return noMath::BitsToFloat( bits, exponentBits, mantissaBits );
}
...
ID_INLINE noVec3 idBitMsg::ReadDir( int numBits ) const {
...
ID_INLINE float idBitMsg::ReadDeltaFloat( float oldValue, int exponentBits, int mantissaBits ) const {
	...
	return noMath::BitsToFloat( newBits, exponentBits, mantissaBits );
}
...
ID_INLINE void idBitMsgDelta::WriteDir( const noVec3 &dir, int numBits ) {
...
ID_INLINE noVec3 idBitMsgDelta::ReadDir( int numBits ) const {
