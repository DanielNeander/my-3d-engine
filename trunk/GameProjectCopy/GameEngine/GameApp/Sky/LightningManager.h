...
namespace VCloud {
	...
	public:
		 ...
		 */
		Lightning* addLightning(const noVec3& p, const noVec3& d, const float l, const uint32& div = RandInt(12, 30));
		 ...
		 */
		void setLightningColor(const noVec3& c);

		/** Get lightning color
		    @return Lightning color
		 */
		inline const noVec3& getLightningColor() const
		{
		 ...
		 */
		void setLightningTimeMultiplier(const float& m)
		{
		 ...
		 */
		inline const float& getLightningTimeMultiplier() const
		{
		 ...
		 */
		inline void setAverageLightningApparitionTime(const float& alat)
		{
		 ...
		 */
		inline const float& getAverageLightningApparitionTime() const
		{
	...
	private:
		...
		/// Lightning color
		noVec3 mLightningColor;
		/// Lightning time multiplier
		float mLightningTimeMultiplier;

		/// Average lightning apparition time (in seconds)
		float mAverageLightningApparitionTime;
