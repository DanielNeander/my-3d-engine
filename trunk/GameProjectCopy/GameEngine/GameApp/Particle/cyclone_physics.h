...
namespace cyclone {
    ...
    public:
         ...
         */
        void setPosition(const noVec3 &position);
         ...
         * the position.
         */
        void getPosition(noVec3 *position) const;
         ...
         */
        void getVelocity(noVec3 *velocity) const;
         ...
         */
        void setAcceleration(const noVec3 &acceleration);
         ...
         */
        void getAcceleration(noVec3 *acceleration) const;
         ...
         */
        void addForce(const noVec3 &force);
