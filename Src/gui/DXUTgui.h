...
struct DXUTBlendColor : public U2MemObj
{
...
//-----------------------------------------------------------------------------
class CDXUTElement : public U2MemObj
{
public:
...
//-----------------------------------------------------------------------------
class CDXUTDialog : public U2MemObj
{
...
//--------------------------------------------------------------------------------------
struct DXUTTextureNode : public U2MemObj
{
...
struct DXUTFontNode : public U2MemObj
{
...
//-----------------------------------------------------------------------------
class CDXUTDialogResourceManager : public U2MemObj
{
public:
...
//-----------------------------------------------------------------------------
class CDXUTControl : public U2MemObj
{
public:
...
//-----------------------------------------------------------------------------
struct DXUTElementHolder : public U2MemObj
{
    UINT nControlType;
    UINT iElement;
...
// ListBox control
//-----------------------------------------------------------------------------
struct DXUTListBoxItem : public U2MemObj
{
    WCHAR strText[256];
    void*  pData;
...
// ComboBox control
//-----------------------------------------------------------------------------
struct DXUTComboBoxItem : public U2MemObj
{
    WCHAR strText[256];
    void*  pData;
...
//-----------------------------------------------------------------------------
class CUniBuffer : public U2MemObj
{
public:
