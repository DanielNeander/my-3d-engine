...
technique11 InitializationTechnique
{
    pass Init
    {
        ...
        SetVertexShader( CompileShader( vs_5_0, InitializationVS()));
        SetGeometryShader(NULL);
        SetPixelShader( CompileShader( ps_5_0, InitializationPS()));
    }
}

technique11 GradientTechnique
{
    pass Grad
    {
		// Same as deformation, but with an alternate PS and without blending.
        ...
        SetVertexShader( CompileShader( vs_5_0, InitializationVS()));
        SetGeometryShader(NULL);
        SetPixelShader( CompileShader( ps_5_0, GradientPS()));
    }
}
