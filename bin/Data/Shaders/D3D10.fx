...
float4 PS_RenderShadows_DX9(PS_INPUT_FINAL i) : SV_Target
{
  ...
  {      
    ...
    {
      float4 pos = i.vTexCoord[iSplit + 1];
      fLightingFactor = g_txShadowMap[iSplit].SampleCmpLevelZero(g_samShadowMap, pos.x/pos.w, pos.y/pos.w, pos.z/pos.w).x;
      break;
    }
  }
...
float4 PS_RenderShadows_MP(PS_INPUT_FINAL i) : SV_Target
{
  ...
  float fLightingFactor = g_txShadowMap[0].SampleCmpLevelZero(, pos.xy/pos.w, pos.z/pos.w);
