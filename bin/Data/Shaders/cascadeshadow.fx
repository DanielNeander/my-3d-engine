...
float4 GetCascadedShadowColor(float4 vTexShadow, float vDepth, float4 vInterpPos )
{
    ...
    float4 vShadowMapTextureCoordViewSpace = vTexShadow;
    if( SELECT_CASCADE_BY_INTERVAL_FLAG ) 
    {
    ...
    if( BLEND_BETWEEN_CASCADE_LAYERS_FLAG && CASCADE_COUNT_FLAG > 1 ) 
    {
        ...
        {  // the current pixel is within the blend band.
            ...
            ComputeCoordinatesTransform( iNextCascadeIndex, vInterpPos, 
