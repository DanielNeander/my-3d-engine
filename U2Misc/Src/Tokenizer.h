...
namespace AURELIO_REIS
{
	...
	class U2MISC CTokenFloat : public CToken
	{
	public:
		float m_fValue;
	...
	class U2MISC CTokenString : public CToken
	{
	public:
		char *m_strValue;
	...
	class U2MISC CTokenOpenBrace : public CToken
	{
	public:
	...
	class U2MISC CTokenClosedBrace : public CToken
	{
	public:
	...
	class U2MISC CTokenQuote : public CToken
	{
	public:
	...
	class U2MISC CTokenOpenBracket : public CToken
	{
	public:
	...
	class U2MISC CTokenClosedBracket : public CToken
	{
	public:
