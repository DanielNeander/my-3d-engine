...
private:
	...
	noVec3					delta;				// delta for next move
...
private:
	...
	monsterMoveResult_t		SlideMove( noVec3 &start, noVec3 &velocity, const noVec3 &delta );
	monsterMoveResult_t		StepMove( noVec3 &start, noVec3 &velocity, const noVec3 &delta );
	void					Rest( void );
