...
private:
	struct pushed_s {
		...
		noAngles	deltaViewAngles;		// actor delta view angles
...
private:
	...
	bool			RotateEntityToAxial( idEntity *ent, noVec3 rotationPoint );
#ifdef NEW_PUSH
	...
	bool			ClipTranslationAgainstPusher( trace_t &results, idEntity *ent, idEntity *pusher, const noVec3 &translation );
	...
	bool			ClipRotationAgainstPusher( trace_t &results, idEntity *ent, idEntity *pusher, const noRotation &rotation );
