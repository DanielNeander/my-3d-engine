...
typedef struct rididBodyIState_s {
	noVec3					position;					// position of trace model
	noMat3					orientation;				// orientation of trace model
	noVec3					linearMomentum;				// translational momentum relative to center of mass
	noVec3					angularMomentum;			// rotational momentum relative to center of mass
} rigidBodyIState_t;

typedef struct rigidBodyPState_s {
	int						atRest;						// set when simulation is suspended
	float					lastTimeStep;				// length of last time step
	noVec3					localOrigin;				// origin relative to master
	noMat3					localAxis;					// axis relative to master
	idVec6					pushVelocity;				// push velocity
	noVec3					externalForce;				// external force relative to center of mass
	noVec3					externalTorque;				// external torque relative to center of mass
...
private:
	...
	noVec3					centerOfMass;				// center of mass of trace model
	noMat3					inertiaTensor;				// mass distribution
...
private:
	...
	bool					CollisionImpulse( const trace_t &collision, noVec3 &impulse );
