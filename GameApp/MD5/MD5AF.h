...
typedef struct jointConversion_s {
	...
	noVec3					jointBodyOrigin;	// origin of body relative to joint
	noMat3					jointBodyAxis;		// axis of body relative to joint
} jointConversion_t;

typedef struct afTouch_s {
	class idEntity *				touchedEnt;
	class idClipModel *			touchedClipModel;
	class idAFBody *				touchedByBody;
} afTouch_t;
...
public:
						...
						void					SetConstraintPosition( const char *name, const noVec3 &pos );
						...
						void					GetPhysicsToVisualTransform( noVec3 &origin, noMat3 &axis ) const;
						void					GetImpactInfo( idEntity *ent, int id, const noVec3 &point, impactInfo_t *info );
						void					ApplyImpulse( idEntity *ent, int id, const noVec3 &point, const noVec3 &impulse );
						void					AddForce( idEntity *ent, int id, const noVec3 &point, const noVec3 &force );
...
protected:
	...
	noVec3					baseOrigin;			// offset of base body relative to skeletal model origin
	noMat3					baseAxis;			// axis of base body relative to skeletal model origin
