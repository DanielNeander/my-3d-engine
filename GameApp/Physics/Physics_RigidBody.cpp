...
void RigidBodyDerivatives( const float t, const void *clientData, const float *state, float *derivatives ) {
	...
	struct rigidBodyDerivatives_s {
		noVec3				linearVelocity;
		noMat3				angularMatrix;
		noVec3				force;
		noVec3				torque;
	} *d = (struct rigidBodyDerivatives_s *) derivatives;
	noVec3 angularVelocity;
...
================
*/
bool idPhysics_RigidBody::CollisionImpulse( const trace_t &collision, noVec3 &impulse ) {
	noVec3 r, linearVelocity, angularVelocity, velocity;
	noMat3 inverseWorldInertiaTensor;
...
void idPhysics_RigidBody::ContactFriction( float deltaTime ) {
	...
	noMat3 inverseWorldInertiaTensor;
	noVec3 linearVelocity, angularVelocity;
	noVec3 massCenter, r, velocity, normal, impulse, normalVelocity;
...
================
*/
void idPhysics_RigidBody::GetImpactInfo( const int id, const noVec3 &point, impactInfo_t *info ) const {
	noVec3 linearVelocity, angularVelocity;
	noMat3 inverseWorldInertiaTensor;
...
================
*/
void idPhysics_RigidBody::ApplyImpulse( const int id, const noVec3 &point, const noVec3 &impulse ) {
	if ( noImpact ) {
		return;
	}
	current.i.linearMomentum += impulse;
...
================
*/
void idPhysics_RigidBody::AddForce( const int id, const noVec3 &point, const noVec3 &force ) {
	if ( noImpact ) {
		return;
	}
...
================
*/
void idPhysics_RigidBody::SetOrigin( const noVec3 &newOrigin, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_RigidBody::SetAxis( const noMat3 &newAxis, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_RigidBody::Translate( const noVec3 &translation, int id ) {
...
================
*/
void idPhysics_RigidBody::Rotate( const noRotation &rotation, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
const noVec3 &idPhysics_RigidBody::GetOrigin( int id ) const {
...
================
*/
const noMat3 &idPhysics_RigidBody::GetAxis( int id ) const {
...
================
*/
void idPhysics_RigidBody::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
...
================
*/
void idPhysics_RigidBody::SetAngularVelocity( const noVec3 &newAngularVelocity, int id ) {
...
================
*/
const noVec3 &idPhysics_RigidBody::GetLinearVelocity( int id ) const {
...
================
*/
const noVec3 &idPhysics_RigidBody::GetAngularVelocity( int id ) const {
...
================
*/
void idPhysics_RigidBody::ClipTranslation( trace_t &results, const noVec3 &translation, const idClipModel *model ) const {
	if ( model ) {
...
================
*/
void idPhysics_RigidBody::ClipRotation( trace_t &results, const noRotation &rotation, const idClipModel *model ) const {
	if ( model ) {
...
================
*/
const noVec3 &idPhysics_RigidBody::GetPushedLinearVelocity( const int id ) const {
...
================
*/
const noVec3 &idPhysics_RigidBody::GetPushedAngularVelocity( const int id ) const {
