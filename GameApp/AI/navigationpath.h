/*$T navigationpath.h GC 1.140 01/03/12 01:39:30 */
...
/**
 *  \ NavigationPath.h NavigationPath component interface for the Navimesh sample program. Included as part of the Game
...
/*
 * NavigationPath NavigationPath is a collection of waypoints that define a
 * movement path for an Actor. This object is ownded by an Actor and filled by
...
public:
	...
	/* ENUMERATIONS & CONSTANTS definition of a waypoint */
	struct WAYPOINT
	{
		noVec3			Position;	/* 3D position of waypoint */
	...
	void									Setup
											(
												...
												const noVec3	&StartPoint,
												NavigationCell	*StartCell,
												const noVec3	&EndPoint,
												NavigationCell	*EndCell
											);
	void									AddWayPoint(const noVec3 &Point, NavigationCell *Cell);
	void									EndPath();
...
/*
 =======================================================================================================================
    ...
    NavigationPath Default Object Constructor
 =======================================================================================================================
 */
...
/*
 =======================================================================================================================
    ~NavigationPath Default Object Destructor
 =======================================================================================================================
 */
inline NavigationPath::~NavigationPath()
{ }
...
/*
 ...
 =======================================================================================================================
 */
inline void NavigationPath::Setup
(
	NavigationMesh	*Parent,
	const noVec3	&StartPoint,
	NavigationCell	*StartCell,
...
/*
 ...
 =======================================================================================================================
 */
inline void NavigationPath::AddWayPoint(const noVec3 &Point, NavigationCell *Cell)
{
	WAYPOINT	NewPoint;
