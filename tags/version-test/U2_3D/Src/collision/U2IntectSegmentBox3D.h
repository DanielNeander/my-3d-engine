...
************************************************************************/
#pragma once
#ifndef U2_INTECTSEGMENTBOX3D_H
#define U2_INTECTSEGMENTBOX3D_H
...
class U2_3D U2IntectSegmentBox3D : public U2Intersector
{
public:
	U2IntectSegmentBox3D(const U2Segment3D& line, const U2Box& box, 
		bool bSolid);

	const U2Segment3D& GetLine() const;
...
typedef U2SmartPtr<U2IntectSegmentBox3D> U2IntectSegmentBox3DPtr;
