...
=====================
*/
monsterMoveResult_t idPhysics_Monster::SlideMove( noVec3 &start, noVec3 &velocity, const noVec3 &delta ) {
	int i;
	trace_t tr;
	noVec3 move;
...
=====================
*/
monsterMoveResult_t idPhysics_Monster::StepMove( noVec3 &start, noVec3 &velocity, const noVec3 &delta ) {
	trace_t tr;
	noVec3 up, down, noStepPos, noStepVel, stepPos, stepVel;
...
================
*/
void idPhysics_Monster::SetDelta( const noVec3 &d ) {
	delta = d;
	if ( delta != vec3_origin ) {
		Activate();
	}
...
================
*/
void idPhysics_Monster::GetImpactInfo( const int id, const noVec3 &point, impactInfo_t *info ) const {
...
================
*/
void idPhysics_Monster::ApplyImpulse( const int id, const noVec3 &point, const noVec3 &impulse ) {
	if ( noImpact ) {
		return;
	}
...
================
*/
void idPhysics_Monster::SetOrigin( const noVec3 &newOrigin, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Monster::SetAxis( const noMat3 &newAxis, int id ) {
...
================
*/
void idPhysics_Monster::Translate( const noVec3 &translation, int id ) {
...
================
*/
void idPhysics_Monster::Rotate( const noRotation &rotation, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Monster::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
...
================
*/
const noVec3 &idPhysics_Monster::GetLinearVelocity( int id ) const {
...
void idPhysics_Monster::SetPushed( int deltaTime ) {
	...
	current.pushVelocity += ( current.origin - saved.origin ) / ( deltaTime * noMath::M_MS2SEC );
}
...
================
*/
const noVec3 &idPhysics_Monster::GetPushedLinearVelocity( const int id ) const {
...
const int	MONSTER_VELOCITY_EXPONENT_BITS	= noMath::BitsForInteger( noMath::BitsForFloat( MONSTER_VELOCITY_MAX ) ) + 1;
