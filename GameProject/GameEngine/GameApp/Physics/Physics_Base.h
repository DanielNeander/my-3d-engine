...
public:	// common physics interface
	...
	void					SetGravity( const noVec3 &newGravity );
	const noVec3 &			GetGravity( void ) const;
	const noVec3 &			GetGravityNormal( void ) const;
...
protected:
	...
	noVec3					gravityVector;			// direction and magnitude of gravity
	noVec3					gravityNormal;			// normalized direction of gravity
