...
bool idPhysics_Static::Evaluate( int timeStepMSec, int endTimeMSec ) {
	noVec3 masterOrigin, oldOrigin;
	noMat3 masterAxis, oldAxis;
...
================
*/
void idPhysics_Static::GetImpactInfo( const int id, const noVec3 &point, impactInfo_t *info ) const {
...
================
*/
void idPhysics_Static::ApplyImpulse( const int id, const noVec3 &point, const noVec3 &impulse ) {
}
...
================
*/
void idPhysics_Static::AddForce( const int id, const noVec3 &point, const noVec3 &force ) {
}
...
================
*/
void idPhysics_Static::SetOrigin( const noVec3 &newOrigin, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Static::SetAxis( const noMat3 &newAxis, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
void idPhysics_Static::Translate( const noVec3 &translation, int id ) {
...
================
*/
void idPhysics_Static::Rotate( const noRotation &rotation, int id ) {
	noVec3 masterOrigin;
	noMat3 masterAxis;
...
================
*/
const noVec3 &idPhysics_Static::GetOrigin( int id ) const {
...
================
*/
const noMat3 &idPhysics_Static::GetAxis( int id ) const {
	return current.axis;
}
...
================
*/
void idPhysics_Static::SetLinearVelocity( const noVec3 &newLinearVelocity, int id ) {
}
...
================
*/
void idPhysics_Static::SetAngularVelocity( const noVec3 &newAngularVelocity, int id ) {
}
...
================
*/
const noVec3 &idPhysics_Static::GetLinearVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_Static::GetAngularVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
void idPhysics_Static::SetGravity( const noVec3 &newGravity ) {
}
...
================
*/
const noVec3 &idPhysics_Static::GetGravity( void ) const {
...
================
*/
const noVec3 &idPhysics_Static::GetGravityNormal( void ) const {
...
================
*/
void idPhysics_Static::ClipTranslation( trace_t &results, const noVec3 &translation, const idClipModel *model ) const {
	if ( model ) {
...
================
*/
void idPhysics_Static::ClipRotation( trace_t &results, const noRotation &rotation, const idClipModel *model ) const {
	if ( model ) {
...
================
*/
const noVec3 &idPhysics_Static::GetPushedLinearVelocity( const int id ) const {
	return vec3_origin;
}
...
================
*/
const noVec3 &idPhysics_Static::GetPushedAngularVelocity( const int id ) const {
	return vec3_origin;
}
