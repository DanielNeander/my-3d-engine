...
================
*/
void idForce_Spring::SetPosition( idPhysics *physics1, int id1, const noVec3 &p1, idPhysics *physics2, int id2, const noVec3 &p2 ) {
...
void idForce_Spring::Evaluate( int time ) {
	float length;
	noMat3 axis;
	noVec3 pos1, pos2, velocity1, velocity2, force, dampingForce;
	impactInfo_t info;
