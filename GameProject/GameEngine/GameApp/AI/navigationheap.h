/*$T navigationheap.h GC 1.140 01/03/12 01:39:30 */
...
/**
 *  \ NavigationHeap.h NavigationHeap component interface for the Navimesh sample program. Included as part of the Game
...
/*
 * include <function.h> ;
 * NavigationNode A NavigationNode represents an entry in the NavigationHeap. It
 * provides some simple operators to classify it against other NavigationNodes
 * when the heap is sorted.
 */
...
/*
 * NavigationHeap A NavigationHeap is a priority-ordered list facilitated by the
 * STL heap functions. This class is also used to hold the current path finding
 * session ID and the desired goal point for NavigationCells to query. Thanks to
 * Amit J. Patel for detailing the use of STL heaps in this way. It's much faster
 * than a linked list or multimap approach.
 */
...
public:
	...
	/*
	 * ENUMERATIONS & CONSTANTS greater<NavigationNode> is an STL thing to create a
	 * 'comparison' object out of ;
	...
	/* OPERATORS MUTATORS */
	void								Setup(int SessionID, const noVec3 &Goal);
...
/*
 =======================================================================================================================
    ...
    NavigationHeap Default Object Constructor
 =======================================================================================================================
 */
...
/*
 =======================================================================================================================
    ~NavigationHeap Default Object Destructor
 =======================================================================================================================
 */
inline NavigationHeap::~NavigationHeap()
{ }
...
/*
 ...
 =======================================================================================================================
 */
inline void NavigationHeap::Setup(int SessionID, const noVec3 &Goal)
{
	m_Goal = Goal;
...
/*
 ...
 =======================================================================================================================
 */
inline const noVec3 &NavigationHeap::Goal() const
{
	return(m_Goal);
}
