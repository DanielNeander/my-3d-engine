...
================
*/
cm_node_t *idCollisionModelManagerLocal::PointNode( const noVec3 &p, cm_model_t *model ) {
	cm_node_t *node;
...
================
*/
int idCollisionModelManagerLocal::PointContents( const noVec3 p, cmHandle_t model ) {
	int i;
	float d;
	cm_node_t *node;
	cm_brushRef_t *bref;
...
==================
*/
int	idCollisionModelManagerLocal::TransformedPointContents( const noVec3 &p, cmHandle_t model, const noVec3 &origin, const noMat3 &modelAxis ) {
	noVec3 p_l;
...
==================
*/
int idCollisionModelManagerLocal::ContentsTrm( trace_t *results, const noVec3 &start,
...
==================
*/
int idCollisionModelManagerLocal::Contents( const noVec3 &start,
									const idTraceModel *trm, const noMat3 &trmAxis, int contentMask,
									cmHandle_t model, const noVec3 &modelOrigin, const noMat3 &modelAxis ) {
	trace_t results;
