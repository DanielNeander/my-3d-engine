...
public:
	...
	void				SetVector( const char *key, const noVec3 &val );
	void				SetVec2( const char *key, const noVec2 &val );
	void				SetVec4( const char *key, const noVec4 &val );
	void				SetAngles( const char *key, const noAngles &val );
	void				SetMatrix( const char *key, const noMat3 &val );
	...
	noVec3				GetVector( const char *key, const char *defaultString = NULL ) const;
	noVec2				GetVec2( const char *key, const char *defaultString = NULL ) const;
	noVec4				GetVec4( const char *key, const char *defaultString = NULL ) const;
	noAngles			GetAngles( const char *key, const char *defaultString = NULL ) const;
	noMat3				GetMatrix( const char *key, const char *defaultString = NULL ) const;
	...
	bool				GetVector( const char *key, const char *defaultString, noVec3 &out ) const;
	bool				GetVec2( const char *key, const char *defaultString, noVec2 &out ) const;
	bool				GetVec4( const char *key, const char *defaultString, noVec4 &out ) const;
	bool				GetAngles( const char *key, const char *defaultString, noAngles &out ) const;
	bool				GetMatrix( const char *key, const char *defaultString, noMat3 &out ) const;
...
ID_INLINE void idDict::SetVector( const char *key, const noVec3 &val ) {
	//Set( key, val.ToString() );
}

ID_INLINE void idDict::SetVec4( const char *key, const noVec4 &val ) {
	//Set( key, val.ToString() );
}

ID_INLINE void idDict::SetVec2( const char *key, const noVec2 &val ) {
	//Set( key, val.ToString() );
}

ID_INLINE void idDict::SetAngles( const char *key, const noAngles &val ) {
	//Set( key, val.ToString() );
}

ID_INLINE void idDict::SetMatrix( const char *key, const noMat3 &val ) {
	Set( key, val.ToString() );
}
...
ID_INLINE noVec3 idDict::GetVector( const char *key, const char *defaultString ) const {
	noVec3 out;
	GetVector( key, defaultString, out );
	return out;
}

ID_INLINE noVec2 idDict::GetVec2( const char *key, const char *defaultString ) const {
	noVec2 out;
	GetVec2( key, defaultString, out );
	return out;
}

ID_INLINE noVec4 idDict::GetVec4( const char *key, const char *defaultString ) const {
	noVec4 out;
	GetVec4( key, defaultString, out );
	return out;
}

ID_INLINE noAngles idDict::GetAngles( const char *key, const char *defaultString ) const {
	noAngles out;
	GetAngles( key, defaultString, out );
	return out;
}

ID_INLINE noMat3 idDict::GetMatrix( const char *key, const char *defaultString ) const {
	noMat3 out;
