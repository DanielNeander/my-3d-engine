...
//--------------------------------------------------------------------------------------
class CDXUTSDKMesh : public Mesh
{
private:
...
protected:
	...
	void                            RenderMesh( UINT iMesh,
		...
		UINT iNormalSlot,
		UINT iSpecularSlot );
	void RenderMesh( UINT iMesh, bool bAdjacent, ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext,ID3DX11EffectTechnique* pTechnique, ID3DX11EffectShaderResourceVariable* ptxDiffuse, ID3DX11EffectShaderResourceVariable* ptxNormal, ID3DX11EffectShaderResourceVariable* ptxSpecular, ID3DX11EffectVectorVariable* pvDiffuse, ID3DX11EffectVectorVariable* pvSpecular );
	void                            RenderFrame( UINT iFrame,
		...
		UINT iNormalSlot,
		UINT iSpecularSlot );
	void RenderFrame( UINT iFrame, bool bAdjacent, ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext, ID3DX11EffectTechnique* pTechnique, ID3DX11EffectShaderResourceVariable* ptxDiffuse, ID3DX11EffectShaderResourceVariable* ptxNormal, ID3DX11EffectShaderResourceVariable* ptxSpecular, ID3DX11EffectVectorVariable* pvDiffuse, ID3DX11EffectVectorVariable* pvSpecular );
...
public:
	...
	/*virtual HRESULT                 Create( IDirect3DDevice9* pDev9, BYTE* pData, UINT DataBytes,
		bool bCreateAdjacencyIndices=false, bool bCopyStatic=false,
		SDKMESH_CALLBACKS9* pLoaderCallbacks=NULL );*/
	HRESULT Create( ID3D11Device* pDev11, LPCWSTR szFileName, bool bCreateAdjacencyIndices = false, SDKMESH_CALLBACKS11* pLoaderCallbacks = NULL);
	...
	void RenderFX( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dDeviceContext,ID3DX11EffectTechnique* pTechnique, 
		ID3DX11EffectShaderResourceVariable* ptxDiffuse= NULL, 
		ID3DX11EffectShaderResourceVariable* ptxNormal= NULL, 
		ID3DX11EffectShaderResourceVariable* ptxSpecular= NULL, 
		ID3DX11EffectVectorVariable* pvDiffuse= NULL,
		ID3DX11EffectVectorVariable* pvSpecular = NULL);
