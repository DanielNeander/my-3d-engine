...
#define COLOR_RGBA(r,g,b,a) \
	((uint)((((r)&0xff)<<24)|(((g)&0xff)<<16)|(((b)&0xff)<<8)|((a)&0xff)))

#define COLOR_XRGB(r,g,b)   COLOR_RGBA(0xff,r,g,b)
...
#define COLOR_COLORVALUE2(r,g,b,a) \
	COLOR_ARGB((DWORD)((r)*255.f),(DWORD)((g)*255.f),(DWORD)((b)*255.f),(DWORD)((a)*255.f))
...
typedef std::vector<PixelFormat> PixelFormatList;
 ...
 class PixelBox : public noBox 
    	...
    	*/
		PixelBox(const noBox &extents, PixelFormat pixelFormat, void *pixelData=0):
			noBox(extents), data(pixelData), format(pixelFormat)
		{
			setConsecutive();
		}
    	...
    	*/
    	PixelBox(size_t width, size_t height, size_t depth, PixelFormat pixelFormat, void *pixelData=0):
    		noBox(0, 0, 0, width, height, depth),
    ...
    public:
        ...
        */
        ...
        /** Gets the format from given name.
            @param  name            The std::string of format name
            @param  accessibleOnly  If true, non-accessible format will treat as invalid format,
                                    otherwise, all supported format are valid.
            @param  caseSensitive   Should be set true if std::string match should use case sensitivity.
        ...
        */
        ...
        /** Gets the BNF expression of the pixel-formats.
            @note                   The std::string returned by this function is intended to be used as a BNF expression
            ...
            @return                A std::string contains the BNF expression.
        */
        static std::string getBNFExpressionOfPixelFormats(bool accessibleOnly = false);
