...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noVec3 &constant, const noVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noVec3 &constant, const noPlane *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noVec3 &constant, const idDrawVert *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noPlane &constant, const noVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noPlane &constant, const noPlane *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noPlane &constant, const idDrawVert *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::Dot( float *dst, const noVec3 *src0, const noVec3 *src1, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] * src1[(X)];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMD_Generic::MinMax( noVec2 &min, noVec2 &max, const noVec2 *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::MinMax( noVec3 &min, noVec3 &max, const noVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMD_Generic::MinMax( noVec3 &min, noVec3 &max, const idDrawVert *src, const int count ) {
	min[0] = min[1] = min[2] = noMath::INFINITY; max[0] = max[1] = max[2] = -noMath::INFINITY;
#define OPER(X) const noVec3 &v = src[(X)].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMD_Generic::MinMax( noVec3 &min, noVec3 &max, const idDrawVert *src, const int *indexes, const int count ) {
	min[0] = min[1] = min[2] = noMath::INFINITY; max[0] = max[1] = max[2] = -noMath::INFINITY;
#define OPER(X) const noVec3 &v = src[indexes[(X)]].xyz; if ( v[0] < min[0] ) { min[0] = v[0]; } if ( v[0] > max[0] ) { max[0] = v[0]; } if ( v[1] < min[1] ) { min[1] = v[1]; } if ( v[1] > max[1] ) { max[1] = v[1]; } if ( v[2] < min[2] ) { min[2] = v[2]; } if ( v[2] > max[2] ) { max[2] = v[2]; }
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMD_Generic::TransformVerts( idDrawVert *verts, const int numVerts, const idJointMat *joints, const noVec4 *weights, const int *index, int numWeights ) {
	int i, j;
...
============
*/
void VPCALL idSIMD_Generic::TracePointCull( byte *cullBits, byte &totalOr, const float radius, const noPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
	byte tOr;
...
============
*/
void VPCALL idSIMD_Generic::DecalPointCull( byte *cullBits, const noPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
...
============
*/
void VPCALL idSIMD_Generic::OverlayPointCull( byte *cullBits, noVec2 *texCoords, const noPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
...
============
*/
void VPCALL idSIMD_Generic::DeriveTriPlanes( noPlane *planes, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
	...
	for ( i = 0; i < numIndexes; i += 3 ) {
		...
		f = noMath::RSqrt( n.x * n.x + n.y * n.y + n.z * n.z );
...
============
*/
void VPCALL idSIMD_Generic::DeriveTangents( noPlane *planes, idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
	...
	for ( i = 0; i < numIndexes; i += 3 ) {
		...
		f = noMath::RSqrt( t0.x * t0.x + t0.y * t0.y + t0.z * t0.z );
		*(unsigned long *)&f ^= signBit;
		...
		f = noMath::RSqrt( t1.x * t1.x + t1.y * t1.y + t1.z * t1.z );
		*(unsigned long *)&f ^= signBit;
...
============
*/
void VPCALL idSIMD_Generic::CreateTextureSpaceLightVectors( noVec3 *lightVectors, const noVec3 &lightOrigin, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
============
*/
void VPCALL idSIMD_Generic::CreateSpecularTextureCoords( noVec4 *texCoords, const noVec3 &lightOrigin, const noVec3 &viewOrigin, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	...
	for ( int i = 0; i < numVerts; i++ ) {
		...
		ilength = noMath::RSqrt( lightDir * lightDir );
		lightDir[0] *= ilength;
		lightDir[1] *= ilength;
		lightDir[2] *= ilength;

		ilength = noMath::RSqrt( viewDir * viewDir );
		viewDir[0] *= ilength;
		viewDir[1] *= ilength;
		viewDir[2] *= ilength;
...
============
*/
int VPCALL idSIMD_Generic::CreateShadowCache( noVec4 *vertexCache, int *vertRemap, const noVec3 &lightOrigin, const idDrawVert *verts, const int numVerts ) {
	int outVerts = 0;
...
============
*/
int VPCALL idSIMD_Generic::CreateVertexProgramShadowCache( noVec4 *vertexCache, const idDrawVert *verts, const int numVerts ) {
	for ( int i = 0; i < numVerts; i++ ) {
		const float *v = verts[i].xyz.ToFloatPtr();
