...
const float noMath::F_EPSILON		= 1.192092896e-07f;
...
================
*/
int noMath::FloatToBits( float f, int exponentBits, int mantissaBits ) {
...
================
*/
float noMath::BitsToFloat( int i, int exponentBits, int mantissaBits ) {
