...
void noFrustum::loadFrustum(const mat4 &mvp){
...
bool noFrustum::pointInFrustum(const vec3 &pos) const {
	for (int i = 0; i < 6; i++){
...
bool noFrustum::sphereInFrustum(const vec3 &pos, const float radius) const {
	for (int i = 0; i < 6; i++){
...
bool noFrustum::cubeInFrustum(const float minX, const float maxX, const float minY, const float maxY, const float minZ, const float maxZ) const {
    for (int i = 0; i < 6; i++){
