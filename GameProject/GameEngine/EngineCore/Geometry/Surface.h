...
public:
	...
	void					TranslateSelf( const noVec3 &translation );
	void					RotateSelf( const noMat3 &rotation );
							...
							// returns a SIDE_?
	int						Split( const noPlane &plane, const float epsilon, idSurface **front, idSurface **back, int *frontOnPlaneEdges = NULL, int *backOnPlaneEdges = NULL ) const;
	...
	bool					LineIntersection( const noVec3 &start, const noVec3 &end, bool backFaceCull = false ) const;
							// intersection point is start + dir * scale
	bool					RayIntersection( const noVec3 &start, const noVec3 &dir, float &scale, bool backFaceCull = false ) const;
...
=================
*/
ID_INLINE void idSurface::TranslateSelf( const noVec3 &translation ) {
...
=================
*/
ID_INLINE void idSurface::RotateSelf( const noMat3 &rotation ) {
	for ( int i = 0; i < verts.Num(); i++ ) {
