...
public:
	...
	void					SetSpline( idCurve_Spline<noVec4> *spline );
	void					SetSweptSpline( idCurve_Spline<noVec4> *sweptSpline );
...
protected:
	idCurve_Spline<noVec4> *spline;
	idCurve_Spline<noVec4> *sweptSpline;

	void					GetFrame( const noMat3 &previousFrame, const noVec3 dir, noMat3 &newFrame );
};
